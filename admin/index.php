  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"><strong><span style="font-size: 38px; margin-top: 10px;">₱</span></strong><br> Total Earnings: ₱<?php include'income-count.php' ?></a></li>
...
<!--                <li class="bg_ls"><i class="fas fa-dumbbell"></i> <strong><?php include 'actions/count-equipments.php';?></strong> <small>Available Equipments</small></li>-->
                ...
                <li class="bg_lr"><i class="fas fa-user-ninja"></i> <strong><?php include 'actions/count-trainers.php';?></strong> <small>Active Trainers</small></li>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; BLACK GYM</a> </div>
</div>
