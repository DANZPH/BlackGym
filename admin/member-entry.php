        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="radio" value="Bodybuilding" name="services" />
                  Bodybuilding <small>- ₱600 per month</small></label>
                <label>
                  <input type="radio" value="Weightloss" name="services" />
                  Weightloss <small>- ₱600 per month</small></label>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="600" name="amount" class="span11">
                  </div>
              </div>
            </div>
