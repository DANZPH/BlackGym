                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #BLACKGYM_<?php echo(rand(100000,10000000));?> <br>Ormedo Street, Gravahan Matina, <br> Davao City</div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
