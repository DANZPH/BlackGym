...
if(isset($_POST['fullname'])){
    ...
    // Insert query with paid_date added
    $qry = "INSERT INTO members (fullname, username, password, dor, gender, services, amount, paid_date, plan, address, contact, status, p_year, attendance_count, ini_weight, curr_weight, ini_bodytype, curr_bodytype, progress_date, reminder) 
